...
/**
 * Utility class responsible for reading configuration properties
 * from the 
...
public class ConfigFileReader {
        ...
        try (InputStream inputStream = getClass().getResourceAsStream(PROPERTY_FILE_PATH)) {
            ...
            if (inputStream == null) {
                throw new RuntimeException(
                        "Configuration file not found at path: " + PROPERTY_FILE_PATH);
            }
            ...
            throw new RuntimeException(
                    "Failed to load configuration file: " + PROPERTY_FILE_PATH, e);
        }
    }
    ...
    public String getProperty(String key) {
        ...
        if (Objects.isNull(value)) {
            throw new RuntimeException(
                    "Property '" + key + "' is not specified in the configuration file.");
        }
